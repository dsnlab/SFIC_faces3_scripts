%-----------------------------------------------------------------------
% Job saved on 29-Aug-2017 13:07:23 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/projects/dsnlab/SFIC_Faces3/fMRI/analysis/fx/multiconds/all_emotions/sub-L001.mat'};

%-----------------------------------------------------------------------
% Job saved on 29-Aug-2017 13:28:18 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/SFIC_Faces3/fMRI/subjects/sub-L001/ses-wave2/facesOB'};
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^s6wob_facesOB';
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{2}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/SFIC_Faces3/fMRI/analysis/fx/models/all_emotions_masked/sub-L001/ses-wave2'};
...
matlabbatch{2}.spm.stats.fmri_spec.sess.multi_reg = {'/projects/dsnlab/SFIC_Faces3/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_001_ses-wave2.txt'};

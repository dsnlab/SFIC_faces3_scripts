...
-qVars "age_c,age_c2" \
-qVarCenters "0,0" \
-mask /projects/dsnlab/SFIC_Faces3/fMRI/analysis/templates/masks/groupAverage_opt.nii	\
-resid	all_residuals	\
-num_glt 1 \
-gltLabel 1 'gender' -gltCode  1 'gender : 1*male -1*female'	\
#-num_glf 4 \
#-glfLabel 1 'age' -glfCode  1 'age_c' \
#-glfLabel 2 'age_sq' -gltCode  2 'age_c2' \
#-glfLabel 3 'age.gender' -gltCode  3 'gender : 1*male -1*female age_c' \
#-glfLabel 4 'age_sq.gender' -gltCode  4 'gender : 1*male -1*female age_c2' \
-dataTable \

...
#--------------------------------------------------------------
#
#SBATCH --job-name=allAff_pds_female
#SBATCH --output=output/allAff_pds_female.log
#SBATCH --error=output/allAff_pds_female_error.log
...
3dLME -prefix allAff_pds_female \
-jobs 8 \

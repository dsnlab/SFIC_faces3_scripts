...
#--------------------------------------------------------------
#
#SBATCH --job-name=allAff_logtest_age_male
#SBATCH --output=output/allAff_logtest_age_male.log
#SBATCH --error=output/allAff_logtest_age_male_error.log
...
3dLME -prefix allAff_logtest_age_male \
-jobs 8 \
...
-qVarCenters "0,0,0" \
-resid	allAff_logtest_age_male_residuals	\
-dataTable \

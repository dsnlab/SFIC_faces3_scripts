...
#--------------------------------------------------------------
#
#SBATCH --job-name=allAff_pds_age
#SBATCH --output=output/allAff_pds_age.log
#SBATCH --error=output/allAff_pds_age_error.log
...
3dLME -prefix allAff_pds_age \
-jobs 8 \
-model  "pdss_c*gender+pdss_c2*gender+age_c" \
-ranEff "~1" \
-SS_type 3 \
-qVars "pdss_c,pdss_c2,age_c" \
-qVarCenters "0,0,0" \
-resid	allAff_pds_age_residuals \
-num_glt 4 \

...
#--------------------------------------------------------------
#
#SBATCH --job-name=allAff_logtest_age
#SBATCH --output=output/allAff_logtest_age.log
#SBATCH --error=output/allAff_logtest_age_error.log
...
3dLME -prefix allAff_logtest_age \
-jobs 8 \
-model  "logtest_c*gender+logtest_c2*gender+age_c" \
-ranEff "~1" \
-SS_type 3 \
-qVars "logtest_c,logtest_c2,age_c" \
-qVarCenters "0,0,0" \
-resid	allAff_logtest_age_residuals \
-num_glt 4 \

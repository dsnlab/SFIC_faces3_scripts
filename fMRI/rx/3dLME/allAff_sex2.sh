...
-glfLabel 2 'age_sq' -glfCode  2 'age_c2' \
-glfLabel 3 'age.gender' -glfCode  3 'gender : 1*male -1*female age_c' \
-glfLabel 4 'age_sq.gender' -glfCode  4 'gender : 1*male -1*female age_c2' \
-dataTable \

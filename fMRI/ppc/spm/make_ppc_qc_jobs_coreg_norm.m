...
% define paths
jobDir = '/Volumes/psych-cog/dsnlab/SFIC/SFIC_faces3_scripts/fMRI/ppc/spm/QC_coreg_norm/';
...
for subCount = 1:97;
	...
	for tCount = 1:3
        ...
        matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_cd.dir = {'/Volumes/psych-cog/dsnlab/SFIC/nonbids_data/fMRI/ppc_QC/coreg_norm'};
        matlabbatch{2}.spm.util.checkreg.data = {
                                                 '/Volumes/psych-cog/dsnlab/SFIC/SFIC_faces3_scripts/fMRI/templates/templates/b_mni_icbm152_t2_tal_nlin_sym_09a.nii,1'
